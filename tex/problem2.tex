...
\begin{solution}
  ...
  \begin{figure}
    \centering
    \includegraphics[width=0.49\textwidth]{images/02_rk4_1.pdf}
    \includegraphics[width=0.49\textwidth]{images/02_rk4_2.pdf}
    \includegraphics[width=0.49\textwidth]{images/02_rk4_3.pdf}
    \includegraphics[width=0.49\textwidth]{images/02_rk4_4.pdf}
